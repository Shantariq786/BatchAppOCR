...
//    let request : SKProductsRequest = SKProductsRequest(productIdentifiers: productIdentifiers as! Set<String>)
        ...
        let productss : Set<String> = Set<String>.init(arrayLiteral: "batchapp.fullversion")

//
//        SKProductsRequest(productIdentifiers: <#T##Set<String>#>
        
        
//        Set<String>

        // Initialize a product request.
        let request = SKProductsRequest(productIdentifiers: productss)
//        let request = SKProductsRequest(productIdentifiers: Set<"com.batchapps.batchbackgroundremover.fullversion">)
